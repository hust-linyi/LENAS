...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', type=str, default='YOUR_ROOT/Experiment/RTDosePrediction/Output/NAS_24/best_val_evaluation_index.pkl')
    parser.add_argument('--TTA', type=bool, default=True,
                        help='do test-time augmentation, default True')
    args = parser.parse_args()

    trainer = NetworkTrainer()
    trainer.setting.project_name = 'NAS_24'
    trainer.setting.output_dir = 'YOUR_ROOT/Experiment/RTDosePrediction/Output/NAS_24'
