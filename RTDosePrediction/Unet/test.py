...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', type=str, default='YOUR_ROOT/Experiment/RTDosePrediction/Output/Unet/best_val_evaluation_index.pkl')
    ...
    trainer.setting.output_dir = 'YOUR_ROOT/Experiment/RTDosePrediction/Output/Unet'
