...
def test_time_augmentation(trainer, input_, TTA_mode):
    ...
    for list_flip_axes in TTA_mode:
        ...
        prediction_B = trainer.setting.network(augmented_input)[0]
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', type=str, default='YOUR_ROOT/Experiment/RTDosePrediction/Output/KD_L2_4_c/best_val_evaluation_index.pkl')
    parser.add_argument('--TTA', type=bool, default=True,
                        help='do test-time augmentation, default True')
    args = parser.parse_args()

    trainer = NetworkTrainer()
    trainer.setting.project_name = 'KD_L2_4_c'
    trainer.setting.output_dir = 'YOUR_ROOT/Experiment/RTDosePrediction/Output/KD_L2_4_c'

    geno_file = 'student_genotype.pkl'
    ...
    # Start inference
    print('\n\n# Start inference !')
    list_patient_dirs = ['YOUR_ROOT/Data/RTDosePrediction/OpenKBP_C3D/pt_' + str(i) for i in range(241, 341)]
