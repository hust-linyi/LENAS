...
def inference(trainer, list_patient_dirs, save_path, do_TTA=True):
    ...
    with torch.no_grad():
        ...
        for patient_dir in tqdm(list_patient_dirs):
            ...
            templete_nii = sitk.ReadImage('YOUR_ROOT/Data/RTDosePrediction/OpenKBP_C3D/pt_1/possible_dose_mask.nii.gz')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', type=str, default='YOUR_ROOT/Experiment/RTDosePrediction/Output/DCNN/best_val_evaluation_index.pkl')
    ...
    trainer.setting.output_dir = 'YOUR_ROOT/Experiment/RTDosePrediction/Output/DCNN'
    ...
    # Start inference
    print('# \n\nStart inference !')
    list_patient_dirs = ['YOUR_ROOT/Data/OpenKBP_DCNN/pt_' + str(i) for i in range(241, 341)]
