...
class Decoder(nn.Module):
    ...
    def forward(self, out_encoder):
        _, _, _, _, out_encoder_5 = out_encoder
        out_decoder_4 = self.decoder_conv_4(self.upconv_4(out_encoder_5))
        out_decoder_3 = self.decoder_conv_3(self.upconv_3(out_decoder_4))
        out_decoder_2 = self.decoder_conv_2(self.upconv_2(out_decoder_3))
        out_decoder_1 = self.decoder_conv_1(self.upconv_1(out_decoder_2))
