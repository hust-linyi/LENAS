...
class MyDataset(data.Dataset):
    def __init__(self, num_samples_per_epoch, phase):
        ...
        self.list_case_id = {'train': ['' + str(i) for i in range(1, 201)],
                             'val': ['' + str(i) for i in range(201, 241)]}[phase]
...
def get_loader(train_bs=1, val_bs=1, train_num_samples_per_epoch=1*50, val_num_samples_per_epoch=1*50, num_works=8):
